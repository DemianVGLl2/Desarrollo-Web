const sw = [
  {
    ...
    year: 1999,
    poster: require("./images/SW1-The_phantom_menace.jpg"),
    best_character: {
      name: "Qui-Gon Jinn",
      affiliation: "Jedi",
      image: require("./images/Qui-Gon_Jinn.png"),
    ...
    comments: {
      ...
      comment: [
        "Excelent movie, it cracked me in half!",
      ],
    }
  },
  {
    ...
    year: 2002,
    poster: require("./images/SW2-Attack_of_the_Clones.jpg"),
    best_character: {
      name: "Obi-wan Kenobi",
      affiliation: "Jedi",
      image: require("./images/Obi-wan_Kenobi.jpg"),
  ...
  },
  {
    ...
    year: 2005,
    poster: require("./images/SW3-Revenge_of_the_sith.jpg"),
    best_character: {
      name: "Anakin Skywalker",
      affiliation: "Sith",
      image: require("./images/Anakin_Skywalker.png"),
  ...
  },
  {
    ...
    title: "A new hope",
    year: 1977,
    poster: require("./images/SW4-A_new_hope.jpg"),
    best_character: {
      name: "Leia Organa",
      affiliation: "Rebellion",
      image: require("./images/Leia_Organa.jpeg"),
  ...
  },
  {
    ...
    year: 1980,
    poster: require("./images/SW5-The_empire_strikes_back.jpg"),
    best_character: {
      name: "Darth Vader",
      affiliation: "Empire",
      image: require("./images/Darth_Vader.jpeg"),
  ...
  },
  {
    ...
    year: 1983,
    poster: require("./images/SW6-The_return_of_the_jedi.jpg"),
    best_character: {
      name: "Luke Skywalker",
      affiliation: "Jedi",
      image: require("./images/Luke_Skywalker.jpeg"),
